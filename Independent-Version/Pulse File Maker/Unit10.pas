...
s_criteria := 'Mean_'+edit2.Text+'_Dev_'+edit3.Text;
...
s_criteria := 'Max_'+edit6.Text+'_Min_'+edit7.Text;
...
form2.Chart1.Series[0].Add(new_pulse_no,'AF_VF_'+inttostr(new_pulse_no)+'_'+s_criteria);
form2.Label2.Caption := '_AF_VF_'+inttostr(new_pulse_no)+'_'+s_criteria;
global_t := global_t + t;
...
procedure TAF_form.Button4Click(Sender: TObject);
begin
...
save_memo.Lines.SaveToFile(savedialog1.FileName+'.AF');
...
procedure TAF_form.Button5Click(Sender: TObject);
begin
