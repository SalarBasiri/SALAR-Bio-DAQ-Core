...
begin
tests_memo.Lines.SaveToFile(savedialog1.filename+label2.caption +'.pmf.tests');
assignfile(out_file,savedialog1.filename+label2.caption +'.pmf');
rewrite(out_file);
