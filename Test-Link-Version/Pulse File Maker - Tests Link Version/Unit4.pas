...
procedure TRecovery_form.Button1Click(Sender: TObject);
begin
...
form2.Chart1.Series[0].Add(max_pulse,'Recovery_'+edit2.Text+'_'+memo1.Lines[0]+'_'+memo1.Lines[c3-1]+'_');
form2.Label2.Caption := '_Recovery_'+edit2.Text+'_'+memo1.Lines[0]+'_'+memo1.Lines[c3-1]+'_';
global_t := global_t + t;
...
procedure TRecovery_form.Button2Click(Sender: TObject);
begin
...
save_memo.Lines.SaveToFile(savedialog1.FileName+'.Recovery');
...
procedure TRecovery_form.Button3Click(Sender: TObject);
begin
...
memo1.Lines.Clear;
for count := 3 to save_memo.Lines.count - 1 do
